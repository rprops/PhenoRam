...
fs <- FCS_resample(fs, sample = 60, replace =)
...
df.Ramanone <- read_csv("./External_data/Ramanome.zip")
...
# Format data into maldiquant/hyperspec object

# Run preprocessing

# 
test <- ram_clust(hs.ramanome, ram_object = "hs", nclust = 20, PCA = TRUE)
